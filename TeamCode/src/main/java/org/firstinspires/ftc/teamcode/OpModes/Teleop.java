...
public class Teleop extends BaseTeleop {
	...
	public Command setupTeleop(CommandScheduler scheduler) {
		...
		robot.gamepad1.whenRightTriggerPressed(new RunCommandLegacy(commandGroups::deposit_teleop));
		...
		robot.gamepad1.whenDPadUpPressed(new RunCommandLegacy(commandGroups::stack5));
		robot.gamepad1.whenDPadRightPressed(new RunCommandLegacy(commandGroups::stack4));
		robot.gamepad1.whenDPadDownPressed(new RunCommandLegacy(commandGroups::stack3));
		robot.gamepad1.whenDPadLeftPressed(new RunCommandLegacy(commandGroups::stack2));
