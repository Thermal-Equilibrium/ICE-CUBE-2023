...
public class RunSimulation {
    public static void main(String[] args) {
        ...
        PrintCommand1 printCommand11 = new PrintCommand1(printSub1, "Test 11");
...
//        Command auto = new MultipleCommand(print1,new MultipleCommand(print2,print3));
        ...
        Command print1 = printCommand1.addNext(printCommand11);
        Command print2 = printCommand2.addNext(printCommand22);

        Command auto = new MultipleCommand(print1, print2);
