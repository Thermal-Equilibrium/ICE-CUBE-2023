...
public class DetectionPipeline extends OpenCvPipeline {
    ...
    protected badpole badpole = new badpole();
    ...
    public Mat processFrame(Mat input) {
        ...
        if (detectedContours.size() < 1) {
            ...
            if (detectedContours.size() > 0) {
                ...
                this.badpole = new badpole(pos,width);
            } else {
                this.badpole = new badpole();
            }

            System.out.println("detected Pole: " + this.badpole);
