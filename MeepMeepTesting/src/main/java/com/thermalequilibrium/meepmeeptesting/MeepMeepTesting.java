...
public class MeepMeepTesting {
	...
	public static void main(String[] args) {
		...
		placeCone2 = shiftRobotRelative(placeCone2, 2.2,2.5);
		Pose2d pickupFull = new Pose2d(-64.5,12.5,Math.toRadians(0));
		Pose2d pickupPartial = new Pose2d(-36, 12.5,Math.toRadians(0));
		...
		Pose2d finalPlaceCone2 = placeCone2;
		RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
				...
				.followTrajectorySequence(drive ->
						drive.trajectorySequenceBuilder(initialPose)
								...
								.splineToSplineHeading(finalPlaceCone1,calculateTangent(goNearScoring1,finalPlaceCone1),slowConstraint,slowConstraintAccel)
...
//								.lineToLinearHeading(placeCone)
								...
								.splineToSplineHeading(finalPlaceCone2, calculateTangent(pickupPartial,finalPlaceCone2),slowConstraint,slowConstraintAccel)
								.setReversed(true)
								.splineTo(pickupPartial.vec(),Math.toRadians(180))
